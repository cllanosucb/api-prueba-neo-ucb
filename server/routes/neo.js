...
app.get('/get_all_users', async function(req,res) { 
    ...
    /*do {  
        const response = await fetch(`https://neo.ucb.edu.bo/api/get_all_users?api_key=55e3bdcb808f8d07f34003a38c8567a8454ecc47d1f3a1de1806&page=${page}`);
        const data = await response.json();
        if(data.length > 0) {
            page += 1;
